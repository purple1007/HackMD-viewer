stroke='white' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'/>
</g>
<defs>
...
<rect width='19' height='19' fill='white' transform='translate(0 0.5)'/>
  ...
  var { widget } = figma;
  var { AutoLayout, Text, Frame, SVG } = widget;
  var HackMDButton = ({ onSuccess }) => {
    return /* @__PURE__ */ figma.widget.h(AutoLayout, {
      ...
      fontSize: 18,
      fontWeight: 500
    }, "Paste your HackMD note into Figma")), /* @__PURE__ */ figma.widget.h(AutoLayout, {
      name: "Frame 4",
      fill: "#564DFF",
      cornerRadius: 8,
      overflow: "visible",
  ...
  var { AutoLayout: AutoLayout2, Span, Text: Text2 } = widget2;
    ...
    static renderList(block, index) {
      ...
      return /* @__PURE__ */ figma.widget.h(AutoLayout2, {
        ...
        return /* @__PURE__ */ figma.widget.h(AutoLayout2, {
          ...
          fill: "#232323",
          width: 18
        }, item.ordered ? `${itemIndex + 1}.` : ""), /* @__PURE__ */ figma.widget.h(Text2, {
          width: "fill-parent"
  ...
  var { AutoLayout: AutoLayout3, Span: Span2, Text: Text3, SVG: SVG2 } = widget3;
    ...
    static renderList(block, index) {
      ...
      return /* @__PURE__ */ figma.widget.h(AutoLayout3, {
        ...
        return /* @__PURE__ */ figma.widget.h(AutoLayout3, {
          ...
          width: "fill-parent",
          padding: { left: 6 }
        }, item.ordered ? /* @__PURE__ */ figma.widget.h(Text3, {
          fill: "#232323",
          width: 18
        }, itemIndex + 1, ".") : item.checkable ? /* @__PURE__ */ figma.widget.h(SVG2, {
  ...
  var { AutoLayout: AutoLayout4, Image, Text: Text4, Span: Span3, SVG: SVG3 } = widget4;
    ...
    static renderImage(block, index) {
      ...
      if (!isValidUrl(block.src)) {
        ...
        return /* @__PURE__ */ figma.widget.h(AutoLayout4, {
          ...
          fill: RedText
        }, "\u5716\u7247\u7DB2\u5740\u7121\u6548"), /* @__PURE__ */ figma.widget.h(Text4, {
          fill: RedText
        }, "\u5716\u7247\u7DB2\u5740\uFF1A", /* @__PURE__ */ figma.widget.h(Span3, {
          href: block.src,
          textDecoration: "underline"
        }, block.src), " "), /* @__PURE__ */ figma.widget.h(Text4, {
          fill: RedText
  ...
  var { AutoLayout: AutoLayout5, Input, Text: Text5, useSyncedState, usePropertyMenu, useEffect, useWidgetId } = widget5;
  function HackMDViewer() {
    ...
    const renderContent = () => {
      if (loading) {
        return /* @__PURE__ */ figma.widget.h(AutoLayout5, null, /* @__PURE__ */ figma.widget.h(Text5, null, "\u8F09\u5165\u4E2D..."));
      }
      if (error) {
        return /* @__PURE__ */ figma.widget.h(AutoLayout5, null, /* @__PURE__ */ figma.widget.h(Text5, {
          fill: "#FF0000"
        }, error));
      }
      if (content) {
